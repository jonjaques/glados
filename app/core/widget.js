define(['jquery', 'knockout', './system', './composition'],
function ($, ko, system, composition) {
	...
	var widget = {
		...
		convertKindToModuleId: function(kind) {
			return kindModuleMaps[kind] || 'core/widgets/' + kind + '/controller';
		},
		convertKindToViewId: function (kind) {
			return kindViewMaps[kind] || 'core/widgets/' + kind + '/view';
		},
